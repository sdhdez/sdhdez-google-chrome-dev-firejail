...
md5sums=('9f3a433133664420777cbae758c0efc2'
...
#source[0]="https://dl.google.com/linux/deb/pool/main/g/google-chrome-${_channel}/google-chrome-${_channel}_71.0.3554.0-1_amd64.deb"
#md5sums[0]='00fa089639e6300891013bd420d4cb86'
